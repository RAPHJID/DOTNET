...
namespace EmailService.Services
{
    public class MailService
    {
        ...
        public async Task sendEmail(UserMessageDto user, string Message, string? subject = "Welcome to JIDAUCTIONS")
        {
            MimeMessage message1 = new MimeMessage();

            message1.From.Add(new MailboxAddress("JidAuctions ", _email));
